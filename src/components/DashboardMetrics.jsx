...
const DashboardMetrics = () => {
  return (
    <div className='bg-dubraPrimary w-full items-center flex flex-col'>

      <div className='grid p-5 lg:grid-cols-2 2xl:grid-cols-4 gap-10'>
        ...
        <ServiceCard
          ...
          background={'outline outline-dubraSecondary bg-dubraPrimary'}/>
