...
const HeroSection = ({title, subtitle, extraComponent, imageSrc, background, textColor, centerContent, customHeight}) => {
  return (
    ...
    <section id='title' className={`flex ${customHeight? customHeight : 'h-150'} w-full bg-cover bg-center justify-center items-center`} style={{ backgroundImage: `url(${imageSrc})` }}>
